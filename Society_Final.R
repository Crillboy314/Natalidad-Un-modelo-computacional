...
####Initiliazing required packages

library(tensorr)

#### Creating the society that will interact within to transate with sex

## First we define the dimension of the person (number of attributes)
...
## Defining values of the functions to compare "prices" that defines 
## relation of positive interaction by considering the ponderating values
